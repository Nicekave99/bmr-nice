...
export default function BMRCalculator() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-200 to-indigo-100 relative overflow-hidden">
      {/* Advanced Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* Main floating orbs */}
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-blue-400/30 to-purple-600/25 rounded-full blur-3xl animate-pulse shadow-2xl"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-tr from-indigo-400/25 to-pink-600/30 rounded-full blur-3xl animate-pulse delay-2000 shadow-2xl"></div>

        {/* Central rotating element */}
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-cyan-300/15 to-blue-500/15 rounded-full blur-3xl animate-spin"
          style={{ animationDuration: "20s" }}
        ></div>

        {/* Additional floating elements */}
        <div
          className="absolute top-20 left-1/4 w-32 h-32 bg-gradient-to-r from-emerald-300/20 to-teal-400/20 rounded-full blur-2xl animate-bounce"
          style={{ animationDuration: "6s" }}
        ></div>
        <div
          className="absolute bottom-32 right-1/3 w-48 h-48 bg-gradient-to-r from-rose-300/15 to-orange-400/15 rounded-full blur-2xl animate-pulse"
          style={{ animationDelay: "1s", animationDuration: "4s" }}
        ></div>

        {/* Small orbiting particles */}
        <div
          className="absolute top-1/4 right-1/4 w-20 h-20 bg-gradient-to-r from-violet-400/25 to-fuchsia-400/25 rounded-full blur-xl animate-ping"
          style={{ animationDelay: "2s", animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-1/4 left-1/3 w-24 h-24 bg-gradient-to-r from-amber-300/20 to-yellow-400/20 rounded-full blur-xl animate-pulse"
          style={{ animationDelay: "0.5s", animationDuration: "5s" }}
        ></div>

        {/* Floating geometric shapes */}
        <div
          className="absolute top-10 right-10 w-16 h-16 bg-gradient-to-r from-sky-400/20 to-cyan-400/20 rotate-45 blur-lg animate-spin"
          style={{ animationDuration: "15s" }}
        ></div>
        <div
          className="absolute bottom-16 left-10 w-12 h-12 bg-gradient-to-r from-purple-400/25 to-indigo-400/25 rounded-lg blur-lg animate-bounce"
          style={{ animationDelay: "1.5s", animationDuration: "4s" }}
        ></div>

        {/* Dynamic wave patterns */}
        <div
          className="absolute top-0 left-0 w-full h-32 bg-gradient-to-r from-blue-200/10 via-purple-200/10 to-indigo-200/10 blur-sm animate-pulse"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-0 right-0 w-full h-24 bg-gradient-to-l from-pink-200/10 via-rose-200/10 to-red-200/10 blur-sm animate-pulse"
        ...
        <div
          className="absolute top-1/3 left-10 w-6 h-6 bg-gradient-to-r from-lime-300/30 to-green-400/30 rounded-full blur-sm animate-bounce"
          style={{ animationDelay: "3s", animationDuration: "3s" }}
        ></div>
        <div
          className="absolute bottom-1/3 right-20 w-8 h-8 bg-gradient-to-r from-red-300/25 to-pink-400/25 rounded-full blur-sm animate-ping"
          style={{ animationDelay: "1.8s", animationDuration: "4s" }}
        ></div>

        {/* Morphing shapes */}
        <div
          className="absolute top-16 left-1/2 w-14 h-14 bg-gradient-to-r from-teal-300/20 to-blue-400/20 rounded-full blur-lg animate-pulse transform -translate-x-1/2"
          style={{ animationDelay: "0.8s", animationDuration: "3.5s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/4 w-18 h-18 bg-gradient-to-r from-orange-300/15 to-red-400/15 rounded-full blur-lg animate-bounce"
